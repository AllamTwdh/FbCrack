...
| | | |/ _` | '__| |/ / | |\/| |/ _ \ / _` |
| |_| | (_| | |  |   < _| |  | | (_) | (_| |
|____/ \__,_|_|  |_|\_(_)_|  |_|\___/ \__,_|""" )
        print ('\033[37;1m-----------------------------------------')
...
def menu():
    ...
    os.system('clear')
    print ("""\033[37;1m ____             _      __  __           _
|  _ \  __ _ _ __| | __ |  \/  | ___   __| |
| | | |/ _` | '__| |/ / | |\/| |/ _ \ / _` |
| |_| | (_| | |  |   < _| |  | | (_) | (_| |
|____/ \__,_|_|  |_|\_(_)_|  |_|\___/ \__,_|""" )
    print ('-----------------------------------------------')
    print ('\033[37;1mAuthor  :\033[31;1m Acil Sean')
    print ('\033[37;1mYouTube :\033[31;1m MR 4444')
    print ('\033[37;1mTools   :\033[31;1m Dark MOD')
    print ('\033[37;1mVersion :\033[31;1m v1.9')
    print ('-----------------------------------------------')
    print
    ...
    print tutup + '\033[37;1m[' + putih + '\033[31;1m03' + tutup + '\033[37;1m] Hack Facebook Target [\033[31;1mWork\033[37;1m ]'
...
def id_member():
    try:
        ...
        idg = raw_input(tutup + '\033[37;1m[' + lime + '\033[32;1m*' + tutup + '\033[37;1m] Input ID Group : '
        try:
        ...
        try:
            print tutup + '\033[37;1m[' + lime + '\033[32;1m*' + tutup + '\033[37;1m] Fetching id from member group ...' + tutup
            ...
            def lanjut(urlz):
                ...
                for z in hasil['data']:
                    idmem.append(z['id'])
                    save.write(z['id'] + '\n')
                    print tutup + '\r\033[37;1m[' + lime + '\033[32;1m*' + tutup + '\033[37;1m] Total : ' + str(len(idmem)),
                    sys.stdout.flush
                    time.sleep(0.0001)
            ...
            ambil()
            save.close()
            print tutup + '\n\033[37;1m[' + lime + '\033[32;1m*' + tutup + '\033[37;1m] Successfully get id from member group'
            ...
            print tutup + '\033[37;1m[' + lime + '\033[31;1m*' + tutup + '\033[37;1m] File saved : ' + lime + 'dump/' + done + tutup
            print tutup + '\033[37;1m[' + lime + '\033[31;1m*' + tutup + '\033[37;1m] Selesai'
            raw_input(tutup + '\nEnter returns to the menu ...')
            menu()
        except (KeyboardInterrupt, IOError, EOFError, KeyError):
            save.close()
            print tutup + '\n\033[37;1m[' + lime + '\033[31;1m*' + tutup + '\033[37;1m] File saved : ' + lime + 'dump/id_member.txt' + tutup
            print tutup + '\033[37;1m[' + lime + '\033[31;1m*' + tutup + '\033[37;1m] Selesai'
            raw_input(tutup + '\nEnter returns to the menu ...')
            menu()
        except requests.exceptions.ConnectionError:
...
def em_teman():
    try:
        ...
        try:
            ...
            print tutup + '\033[37;1m[' + lime + '\033[31;1m*' + tutup + '\033[37;1m] Create file ...'
            time.sleep(2)
...
def em_dariteman():
    try:
        ...
        try:
            ...
            done = raw_input(tutup + '\033[37;1m[' + lime + '\033[31;1m*' + tutup + '\033[37;1m] Save file with name : ' + lime)
            print tutup + '[' + lime + '+' + tutup + '] Create file ...'
            time.sleep(2)
...
def em_member():
    try:
        ...
        try:
            r = requests.get('https://graph.facebook.com/group/?id=' + idg + '&access_token=' + token)
            s = json.loads(r.text)
            print tutup + '\033[37;1m[' + blue + '\xe2\x9c\x93' + tutup + '\033[37;1m] Name Group : ' + merah + s['name'] + tutup
        except KeyError:
            print tutup + '\033[37;1m[' + merah + '\033[31;1m*' + tutup + '\033[37;1m] Group Not Found'
            raw_input(tutup + '\nEnter returns to the menu ...')
            menu()
        ...
        try:
            ...
            done = raw_input(tutup + '\033[37;1m[' + lime + '\033[31;1m*' + tutup + '] Save file with name : '
            print tutup + '[' + lime + '+' + tutup + '] Create file ...'
            time.sleep(2)
            os.rename('dump/em_member.txt', 'dump/' + done)
            print tutup + '\033[37;1m[' + lime + '\033[31;1m*' + tutup + '\033[37;1m] File saved : ' + merah + 'dump/' + done + tutup
            print tutup + '\033[37;1m[' + lime + '\033[31;1m*' + tutup + '\033[37;1m] Selesai'
            raw_input(tutup + '\nEnter returns to the menu ...')
            menu()
        except KeyboardInterrupt:
...
def no_teman():
    try:
        ...
        try:
            r = requests.get('https://graph.facebook.com/me/friends?access_token=' + token)
            s = json.loads(r.text)
            print tutup + '\033[37;1m[' + lime + '\033[32;1m*' + tutup + '\033[37;1m] Fetching number phone all friend ...' + tutup
            ...
            for i in s['data']:
                ...
                try:
                    ...
                    print tutup + '\r\033[37;1m[ ' + merah + str(len(nofriend)) + tutup + ' \033[37;1m] ' + z['mobile_phone'] + ' | ' + z['name'] + '\n',
                    sys.stdout.flush()
                    time.sleep(0.0001)
                except KeyError:
                    pass
            ...
            print tutup + '\033[37;1m[' + lime + '\033[31;1m*' + tutup + '\033[37;1m] File saved : ' + merah + 'dump/' + done + tutup
            print tutup + '\033[37;1m[' + lime + '\033[31;1m*' + tutup + '] Selesai'
            raw_input(tutup + '\nEnter returns to the menu ...')
            menu()
        except KeyboardInterrupt:
            save.close()
            ...
            time.sleep(2)
            os.rename('dump/no_teman.txt', 'dump/' + done)
            print tutup + '\033[37;1m[' + lime + '\033[31;1m*' + tutup + '\032[37;1m] File saved : ' + merah + 'dump/' + done + tutup
            print tutup + '\033[37;1m[' + lime + '\033[31;1m*' + tutup + '\033[37;1m] Selesai'
            raw_input(tutup + '\nEnter returns to the menu ...')
            menu()
...
def no_dariteman():
    try:
        ...
        try:
            r = requests.get('https://graph.facebook.com/' + idt + '?access_token=' + token)
            p = json.loads(r.text)
            print tutup + '\033[37;1m[' + blue + '\xe2\x9c\x93' + tutup + '\033[37;1m] Get Number From : ' + merah + p['name']
        except KeyError:
            print tutup + '\033[37;1m[' + merah + '\033[31;1m*' + tutup + '\033[37;1m] Not Found'
            raw_input(tutup + '\nEnter returns to the menu ...')
            menu()
        ...
        try:
            r = requests.get('https://graph.facebook.com/' + idt + '/friends?access_token=' + token)
            a = json.loads(r.text)
            print tutup + '\033[37;1m[' + lime + '\033[33;1m*' + tutup + '\033[37;1m] Fetching number phone all friend from ' + merah + p['name'] + tutup
            ...
            save.close()
            print tutup + '\n\033[37;1m[' + lime + '\033[33;1m*' + tutup + '\033[37;1m] Successfully get number phone friend from ' + merah + p['name'] + tutup
            done = raw_input(tutup + '\033[37;1m[' + lime + '\033[31;1m*' + tutup + '\033[37;1m] Save file with name : '
            print tutup + '[' + lime + '+' + tutup + '] Create file ...'
            time.sleep(2)
...
def no_member():
    ...
    try:
            r = requests.get('https://graph.facebook.com/group/?id='+idg+'&access_token='+token)
            s = json.loads(r.text)
	    print tutup+"\033[37;1m["+blue+"\033[32;1m*"+tutup+"\033[37;1m] Name Group : "+merah+s["name"]+tutup
    except KeyError:
	    print tutup+"\033[37;1m["+merah+"\033[31;1m*"+tutup+"\033[37;1m] Group Not Found"
	    raw_input(tutup+"\nEnter returns to the menu ...")
	    menu()
    try:
	    ...
	    for a in z['data']:
		    ...
		    try:
			    ...
			    save.write(z['mobile_phone']+'\n')
			    print (tutup+"\r\033[37;1m[ "+merah+str(len(nomem))+tutup+" \033[37;1m] "+z['mobile_phone']+" | "+z['name']+"\n"),;sys.stdout.flush();time.sleep(0.0001)
		    except KeyError: pass
	    save.close()
	    print tutup+"\n\033[37;1m["+lime+"\033[33;1m*"+tutup+"\033[37;1m] Successfully get number phone from member group"
	    done = raw_input(tutup+"\033[37;1m["+lime+"\033[31;1m*"+tutup+"\033[37;1m] Save file with name : "
	    print tutup+"\033[37;1m["+lime+"+"+tutup+"] Create file ..."; time.sleep(2)
	    ...
	    save.close()
	    print tutup+"\n["+lime+"\033[33;1m*"+tutup+"\033[37;1m] Successfully get number phone from member group"
	    done = raw_input(tutup+"\033[37;1m["+lime+"\033[31;1m*"+tutup+"\033[37;1m] Save file with name : "
